    ...
    <>
      ...
      <div className="container">
        ...
        <div className="poem">
          ...
          <div className="poem-line">Antes, e com tal zelo, e sempre, e tanto</div>
          ...
          <div className="poem-line">E em seu louvor hei de espalhar meu canto</div>
          ...
          <div className="poem-line">Quem sabe a morte, angústia de quem vive</div>
          ...
          <div className="poem-line">Que não seja imortal, posto que é chama</div>
